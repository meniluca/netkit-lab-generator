...
foreach my $name ( @unique_ospf ) {
    ...
    `echo "!" >> $name/etc/zebra/ospfd.conf`;
    `echo "!interface ethX" >> $name/etc/zebra/ospfd.conf`;
    `echo "!ospf cost N" >> $name/etc/zebra/ospfd.conf`;
    ...
    `echo "network XXX.XXX.XXX.XXX/NM area Y.Y.Y.Y" >> $name/etc/zebra/ospfd.conf`;
    `echo "!area Y.Y.Y.Y stub" >> $name/etc/zebra/ospfd.conf`;
